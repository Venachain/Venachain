...
func newTester(t *testing.T, confOverride func(*vena.Config)) *tester {
	...
	if err = stack.Register(func(ctx *node.ServiceContext) (node.Service, error) { return vena.New(ctx, ethConf) }); err != nil {
