...
// account array.
func checkStateAccounts(t *testing.T, db dbhandle.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db dbhandle.Database, root common.Hash) error {
...
func checkStateConsistency(db dbhandle.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(dbhandle.Database), srcRoot)
