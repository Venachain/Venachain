...
type Trie interface {
	...
	Prove(key []byte, fromLevel uint, proofDb venadb.Putter) error
}
...
func NewDatabase(db venadb.Database) Database {
	//LRU
...
func (m cachedTrie) Prove(key []byte, fromLevel uint, proofDb venadb.Putter) error {
