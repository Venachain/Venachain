...
func TestInvalidTransactions(t *testing.T) {
	...
	//b := common.SysCfg.GetIsTxUseGas()
	//c := common.SysCfg.GetGasContractName() != ""
	//fmt.Println("name",common.SysCfg.GetGasContractName())
	//
	//fmt.Println("b",b)
	//fmt.Println("c",c)
	...
	//
	//pool.add(tx1, false)
	//if _, err := pool.add(tx1, false); err != ErrTransactionRepeat {
	//	t.Error("expected", ErrTransactionRepeat,"got",err)
	//}
...
func TestTransactionDropping(t *testing.T) {
	...
	//	t.Errorf("funded queued transaction missing: %v", tx10)
	//}
	//if _, ok := pool.pending[account].items[tx12.Nonce()]; ok {
...
//			if pool.pending[account].Len() != int(i) {
//				t.Errorf("tx %d: queue size mismatch: have %d, want %d", i, pool.pending[account].Len(), i)
//			}
//		} else {
//			if pool.pending[account].Len() != int(testTxPoolConfig.AccountQueue) {
//				t.Errorf("tx %d: queue limit mismatch: have %d, want %d", i, pool.pending[account].Len(), testTxPoolConfig.AccountQueue)
//			}
//		}
//	}
...
func TestTransactionPendingGlobalLimiting(t *testing.T) {
	...
	pool.config.GlobalSlots = config.AccountSlots * 10
	//fmt.Println("1",config.GlobalSlots)
	//fmt.Println("2",pool.config.GlobalSlots)
	defer pool.Stop()
...
//	//pending, queued = pool.Stats()
//	//if pending != 10 {
//	//	t.Fatalf("pending transactions mismatched: have %d, want %d", pending, 10)
//	//}
//	//if queued != 5 {
