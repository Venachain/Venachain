...
import (
	...
	"github.com/Venachain/Venachain/cmd/venachaincli/cmd"
	"github.com/Venachain/Venachain/cmd/venachaincli/rest"
	"gopkg.in/urfave/cli.v1"
)

var (
	app = utils.NewApp("", "Venachain interaction command line interface")
)
