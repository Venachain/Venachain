...
import (
	...
	utl "github.com/Venachain/Venachain/cmd/venachaincli/client/utils"
	cmd_common "github.com/Venachain/Venachain/cmd/venachaincli/common"
...
var (
	...
	FwExportCmd = cli.Command{
		...
		Description: `
		venachaincli fw export <address>`,
	}
	...
	FwImportCmd = cli.Command{
		...
		Flags:     fwImportCmdFlags,
		Description: `
		venachaincli fw import <address>`,
	}
	...
	FwNewCmd = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		venachaincli fw new <address> <action> <account> <api>

Example: ./venachaincli fw new 0xcce493dcb135a19928627a7d5a0df0b1477fbce7 \
...
The * is stand for all account addresses or APIs`,
	...
	FwDeleteCmd = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		venachaincli fw delete <address> <action> <account> <api>`,
	}
	...
	FwResetCmd = cli.Command{
		...
		Flags:     globalCmdFlags,
		Description: `
		venachaincli fw reset <address> <action> <account> <api>`,
	}
