...
var (
	NodeCmd = cli.Command{
		Name:  "node",
		Usage: "Manage nodes in VenaChain network",
	...
	NodeAddCmd = cli.Command{
		...
		Description: `
		venachaincli admin node add <name> <publicKey> <externalIP> <internalIP>
...
The newly added nodes can only be observer type.`,
	...
	NodeDeleteCmd = cli.Command{
		...
		Description: `
		venachaincli admin node delete <name>`,
	}
	...
	NodeUpdateCmd = cli.Command{
		...
		Description: `
		venachaincli admin node update <name>`,
	}
