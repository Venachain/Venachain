...
var (
	...
	TxPoolAccountQueueFlag = cli.Uint64Flag{
		...
		Value: vena.DefaultConfig.TxPool.AccountQueue,
	}
	TxPoolGlobalQueueFlag = cli.Uint64Flag{
		Name:  "txpool.globalqueue",
		Usage: "Maximum number of non-executable transaction slots for all accounts",
		Value: vena.DefaultConfig.TxPool.GlobalQueue,
	}
	TxPoolGlobalTxCountFlag = cli.Uint64Flag{
		Name:  "txpool.globaltxcount",
		Usage: "Maximum number of transactions for package",
		Value: vena.DefaultConfig.TxPool.GlobalTxCount,
	}
	TxPoolLifetimeFlag = cli.DurationFlag{
		Name:  "txpool.lifetime",
		Usage: "Maximum amount of time non-executable transaction are queued",
		Value: vena.DefaultConfig.TxPool.Lifetime,
	}
...
func MakeChainDatabase(ctx *cli.Context, stack *node.Node) venadb.Database {
	var (
...
func MakeChain(ctx *cli.Context, stack *node.Node) (chain *core.BlockChain, chainDb venadb.Database) {
	var err error
...
// new format.
//
// e.g. venachain account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// venachain --keystore /tmp/mykeystore --lightkdf account new
//
