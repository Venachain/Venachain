...
func newTestLDB() (*venadb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "ethdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := venadb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func OpenTestLDB() (*venadb.LDBDatabase, func()) {
...
func testGetValue(db venadb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(venadb.NewMemDatabase(), t)
}

func testPutGet(db venadb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(venadb.NewMemDatabase(), t)
}

func testParallelPutGet(db venadb.Database, t *testing.T) {
	const n = 8
