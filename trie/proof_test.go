...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *venadb.MemDatabase {
	var provers []func(key []byte) *venadb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *venadb.MemDatabase {
		proof := venadb.NewMemDatabase()
