...
type Database struct {
	diskdb venadb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb venadb.Database) *Database {
	return &Database{
		diskdb:    diskdb,
...
func (db *Database) commit(hash common.Hash, batch venadb.Batch) error {
