...
func (c *core) checkMessage(msgCode uint64, view *iris.View) error {
...
func (c *core) storeBacklog(msg *message, src iris.Validator) {
...
func toPriority(msgCode uint64, view *iris.View) float32 {
	if msgCode == msgRoundChange {
