...
func (c *core) handleRequest(request *iris.Request) error {
...
func (c *core) checkRequestMsg(request *iris.Request) error {
...
func (c *core) storeRequestMsg(request *iris.Request) {
...
func (c *core) processPendingRequests() {
	...
	for !(c.pendingRequests.Empty()) {
		...
		go c.sendEvent(iris.RequestEvent{
			Proposal: r.Proposal,
		})
	}
}
