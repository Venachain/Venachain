...
func New(backend iris.Backend, config *params.IstanbulConfig) Engine {
...
type core struct {
	...
	msgCh                 chan iris.MessageEvent
	finalCommittedSub     *event.TypeMuxSubscription
	timeoutSub            *event.TypeMuxSubscription
	futurePreprepareTimer *time.Timer

	valSet                iris.ValidatorSet
...
func (c *core) currentView() *iris.View {
	return &iris.View{
...
func (c *core) singleCommit(proposal iris.Proposal) {
...
func (c *core) catchUpRound(view *iris.View) {
...
func (c *core) updateRoundState(view *iris.View, validatorSet iris.ValidatorSet, roundChange bool) {
...
func (c *core) checkValidatorSignature(data []byte, sig []byte) (common.Address, error) {
	return iris.CheckValidatorSignature(c.valSet, data, sig)
}
