...
func (c *core) handlePrepare(msg *message, src iris.Validator) error {
	logger := c.logger.New("from", src, "state", c.state)
	logger.Trace("handlePrepare")
	// Decode PREPARE message
	var prepare *iris.Subject
...
func (c *core) verifyPrepare(prepare *iris.Subject, src iris.Validator) error {
	logger := c.logger.New("from", src, "state", c.state)
...
func (c *core) acceptPrepare(msg *message, src iris.Validator) error {
	logger := c.logger.New("from", src, "state", c.state)
