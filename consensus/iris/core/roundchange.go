...
func (c *core) handleRoundChange(msg *message, src iris.Validator) error {
...
func newRoundChangeSet(valSet iris.ValidatorSet) *roundChangeSet {
...
type roundChangeSet struct {
	validatorSet iris.ValidatorSet
