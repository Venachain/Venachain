...
func TestVerifyPrepare(t *testing.T) {
	...
	valSet := validator.NewSet([]common.Address{peer.Address()}, iris.RoundRobin)
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: nil,
			prepare: &iris.Subject{
				View:   &iris.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&iris.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
				valSet,
			),
		},
		{
			...
			roundState: newTestRoundState(
				&iris.View{Round: big.NewInt(1), Sequence: big.NewInt(1)},
				valSet,
			),
		},
		{
		...
		},
		{
			...
			expected: errInconsistentSubject,
			prepare: &iris.Subject{
				View:   &iris.View{Round: big.NewInt(0), Sequence: nil},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&iris.View{Round: big.NewInt(1), Sequence: big.NewInt(1)},
		...
		},
		{
			...
			expected: errInconsistentSubject,
			prepare: &iris.Subject{
				View:   &iris.View{Round: big.NewInt(1), Sequence: big.NewInt(0)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&iris.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
		...
		},
		{
			...
			expected: errInconsistentSubject,
			prepare: &iris.Subject{
				View:   &iris.View{Round: big.NewInt(0), Sequence: big.NewInt(1)},
				Digest: newTestProposal().Hash(),
			},
			roundState: newTestRoundState(
				&iris.View{Round: big.NewInt(0), Sequence: big.NewInt(0)},
