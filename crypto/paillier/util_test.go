...
func TestPaillierWeightAdd(t *testing.T) {
	...
	arr := []uint{3,5,2}
	result := PaillierWeightAdd(str,arr,"95812e8c3bafc54adae58e01e2777a3de717312e2efe8b764c3a684a46106db7")
...
func TestPaillierAdd(t *testing.T) {
	...
	result := PaillierAdd(str,"95812e8c3bafc54adae58e01e2777a3de717312e2efe8b764c3a684a46106db7")
...
func TestPaillierMulPro(t *testing.T) {
	...
	arr := uint(3)
	result := PaillierMul(str,arr,"95812e8c3bafc54adae58e01e2777a3de717312e2efe8b764c3a684a46106db7")
